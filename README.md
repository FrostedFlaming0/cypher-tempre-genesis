...
|---|---|
| Claude Code | [cypher-tempre-claude-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-claude-skill-v3.7.0.zip) |
| Codex | [cypher-tempre-codex-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-codex-skill-v3.7.0.zip) |
| OpenClaw | [cypher-tempre-openclaw-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-openclaw-skill-v3.7.0.zip) |
| Hermes | [cypher-tempre-hermes-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-hermes-skill-v3.7.0.zip) |
| NanoClaw | [cypher-tempre-nanoclaw-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-nanoclaw-skill-v3.7.0.zip) |
...
| [cypher-tempre-claude-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-claude-skill-v3.7.0.zip) | Claude Code skill bundle with lifecycle hooks |
| [cypher-tempre-codex-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-codex-skill-v3.7.0.zip) | Codex skill bundle with lifecycle hook installer |
| [cypher-tempre-openclaw-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-openclaw-skill-v3.7.0.zip) | OpenClaw skill bundle with native plugin enforcement and self-enforcement fallback |
| [cypher-tempre-hermes-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-hermes-skill-v3.7.0.zip) | Hermes skill bundle with self-enforcement instructions |
| [cypher-tempre-nanoclaw-skill-v3.7.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/raw/main/downloads/cypher-tempre-nanoclaw-skill-v3.7.0.zip) | NanoClaw skill bundle |
...
`cypher-tempre-codex-skill-v3.7.0.zip`. After installing hooks, open `/hooks`
