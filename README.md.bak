...
|---|---|
| Claude Code | [cypher-tempre-claude-skill-v3.0.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-claude-skill-v3.0.0.zip) |
| Codex | [cypher-tempre-codex-skill-v3.0.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-codex-skill-v3.0.0.zip) |
| OpenClaw | [cypher-tempre-openclaw-skill-v3.0.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-openclaw-skill-v3.0.0.zip) |
| Hermes | [cypher-tempre-hermes-skill-v3.0.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-hermes-skill-v3.0.0.zip) |
| NanoClaw | [cypher-tempre-nanoclaw-skill-v3.0.0.zip](https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-nanoclaw-skill-v3.0.0.zip) |
...
such as `https://github.com/cyberphysicsai/cypher-tempre-genesis/releases/download/v3.0.0/cypher-tempre-codex-skill-v3.0.0.zip`.
