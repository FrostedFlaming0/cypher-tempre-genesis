...
version: 1.0.0
homepage: https://github.com/cyberphysicsai/cyphertempre
user-invocable: true
metadata:
  openclaw:
    requires:
...
Use this bundle as the OpenClaw version of Cypher Tempre. The files in
`skills/openclaw/cypher-tempre-self-model/` belong to the OpenClaw skill package.
