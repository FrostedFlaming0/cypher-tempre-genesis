...
- `cypher-tempre-claude-skill-v3.11.3.zip` is the Claude Code skill bundle with
  lifecycle hooks.
- `cypher-tempre-codex-skill-v3.11.3.zip` is the Codex skill bundle with
  the Codex lifecycle hook installer and reviewable hook template.
- `cypher-tempre-openclaw-skill-v3.11.3.zip` is the OpenClaw skill bundle with
  native plugin enforcement and explicit mark/seal/stop-check fallback.
- `cypher-tempre-hermes-skill-v3.11.3.zip` is the Hermes skill bundle with
  explicit Hermes self-enforcement instructions and subagent definition.
- `cypher-tempre-nanoclaw-skill-v3.11.3.zip` is the NanoClaw skill bundle.
