...
`~/.claude/skills/cypher-tempre-self-model/`). On **every meaningful turn**, run the
...
`python3 ~/.claude/skills/cypher-tempre-self-model/dormancy.py pause --confirm`
...
```bash
SK=~/.claude/skills/cypher-tempre-self-model
